...
from openfisca_france_indirect_taxation.scripts.build_coicop_legislation import (
    apply_modification,
)
...
def add_fiscal_categories_to_bdf_nomenclature(bdf_nomenclature, to_csv=False):
    ...
    fiscal_rules = [
        ...
        },
        {
            ...
            "categorie_fiscale": "tva_taux_reduit",
            "stop": 2011,
        },  # Transport combine de passagers
        {
            "value": "07.3.5",
            "categorie_fiscale": "tva_taux_intermediaire",
            "start": 2012,
        ...
        },
        {
            "value": "11.1.1.2",
            "categorie_fiscale": "tva_taux_plein",
        },  # Boissons alcoolisées (cafés, bars et assimilés)
        {
            "value": "11.1.2",
            "categorie_fiscale": "tva_taux_reduit",
