...
def _handle_overlap_middle(df, overlap_selection, start, stop, categorie_fiscale):
    ...
    df.loc[overlap_selection, ["categorie_fiscale", "start", "stop"]] = (
        categorie_fiscale,
        start,
        stop,
    )
        ...
        if not filled_start_stop:
            ...
            if overlap_selection.any():
                if (overlap_selection & equal_start & equal_stop).any():
                    ...
                    coicop_nomenclature.loc[
                        overlap_selection & equal_start & equal_stop,
                        "categorie_fiscale",
                    ] = categorie_fiscale
...
def add_fiscal_categories_to_coicop_nomenclature(coicop_nomenclature, to_csv=False):
    ...
    fiscal_rules = [
        ...
        },  # Produits de confiserie (hors chocolat)
